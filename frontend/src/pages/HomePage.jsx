        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-left">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 sm:gap-3 pt-1 pb-1">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 bg-white p-2 sm:p-2.5 rounded-xl border border-slate-200 shadow-sm text-left col-span-2 sm:col-span-1">
            ...
            {/* Hero Action Buttons & Google Review Box */}
            <div className="flex flex-wrap items-center gap-2.5 pt-1">
              
              {/* Call Now Button */}
              <a
                href={SITE_DATA.callUrl}
                className="py-3 px-4 sm:py-3.5 sm:px-6 rounded-2xl bg-yellow-500 hover:bg-yellow-400 text-blue-950 font-black text-xs sm:text-sm shadow-lg shadow-yellow-500/30 flex items-center gap-2.5 transition-all hover:scale-[1.02]"
              >
                <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-blue-950 flex items-center justify-center text-yellow-300">
                  <Phone className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                </div>
                <div className="text-left">
                  <div className="text-xs sm:text-sm font-black">Call Now</div>
                  <div className="text-[9px] sm:text-[10px] font-extrabold text-blue-900/80">Instant Assistance</div>
                </div>
              </a>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-[9px] sm:text-[10px] font-semibold text-slate-500">Quick Response</div>
                </div>
              </a>

              {/* Google Rating Box */}
              <div className="bg-white px-3 py-2 sm:px-4 sm:py-2.5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-2.5">
                <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-100 flex items-center justify-center font-black text-xs sm:text-sm text-blue-600">
                  G
                </div>
                <div className="text-left">
                  <div className="flex items-center gap-1">
                    <span className="text-[11px] sm:text-xs font-black text-slate-900">Rated {SITE_DATA.ratingScore}</span>
                  ...
                  <div className="text-[8px] sm:text-[10px] font-bold text-slate-400">{SITE_DATA.ratingReviews}</div>
                </div>
              </div>
      ...
      <section id="services-cards" className="py-10 sm:py-16 px-2 sm:px-6 lg:px-8 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto space-y-6 sm:space-y-10">
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4 md:gap-6">
            ...
            <div className="bg-slate-50 rounded-2xl sm:rounded-3xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-200 group flex flex-col justify-between col-span-3 sm:col-span-3 lg:col-span-2">
              <div>
                <div className="relative h-24 sm:h-36 md:h-44 w-full overflow-hidden bg-slate-200">
                  <img
